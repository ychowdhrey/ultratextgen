...
| [`local-only-locale-exceptions.md`](./local-only-locale-exceptions.md) | every page ratified as needing no English parent, with its evidence, plus one superseded entry and one counter-example |
