...
13. ~~**`/updates/` lane missing from the map and the classifier.**~~ **Closed
    ...
    in ``.claude/rules/content-architecture.md` section — including a same-day
