...
{az_links}
    ...
    <!-- Sibling printables. Picks: the owner's route for this page (a custom
         name as a dot-to-dot) plus the same ready-made letters to color.
         Revisit with GA4 co-visitation data. -->
    <section class="editorial-section pt-siblings" aria-labelledby="ptSiblingsHeading">
      ...
      <div class="printable-hub-grid">
        <a class="printable-card" href="/printables/dot-to-dot-name/">
          <span class="printable-card-art" aria-hidden="true">E·m·m·a</span>
          <h3>Dot-to-dot name</h3>
          <p>Type a name or word and print it as one connect-the-dots puzzle, from Easy to Expert.</p>
          <span class="printable-card-cta">Make a name dot-to-dot →</span>
        </a>
        <a class="printable-card" href="/printables/alphabet-coloring-pages/">
          <span class="printable-card-art" aria-hidden="true">𝔸 𝔹 ℂ</span>
          <h3>Alphabet coloring pages</h3>
          <p>These letters as plain outlines to color, with no dots: one per page, A–Z and 0–9.</p>
          <span class="printable-card-cta">Open coloring pages →</span>
        </a>
      </div>
    </section>
