...
PAGES = {
  ...
  "library-cat-kaomoji": ("Cat Kaomoji", "Cute cat text faces, copy-ready", m_kaomoji, K_LIB),
  "library-crying-kaomoji": ("Crying Kaomoji", "Sad and teary text faces", m_kaomoji, K_LIB),
  "library-cute-kaomoji": ("Cute Kaomoji", "Kawaii text faces, copy-ready", m_kaomoji, K_LIB),
  "library-happy-kaomoji": ("Happy Kaomoji", "Smiling, joyful text faces", m_kaomoji, K_LIB),
  "library-love-kaomoji": ("Love Kaomoji", "Heart-eyed love text faces", m_kaomoji, K_LIB),
  "library-sparkle-kaomoji": ("Sparkle Kaomoji", "Sparkly, starry text faces", m_kaomoji, K_LIB),
  "library-lenny-face": ("Lenny Face", "( ͡° ͜ʖ ͡°) and every variant", m_kaomoji, K_LIB),
  "library-heart-kaomoji": ("Heart Kaomoji", "Heart-eyed love text faces", m_kaomoji, K_LIB),
  "library-sad-kaomoji": ("Sad Kaomoji", "Gloomy and sulking text faces", m_kaomoji, K_LIB),
  "library-star-kaomoji": ("Star Kaomoji", "Starry-eyed text faces", m_kaomoji, K_LIB),
  "library-shrug-kaomoji": ("Shrug Kaomoji", "The classic shrug text face", m_kaomoji, K_LIB),
  "library-bunny-kaomoji": ("Bunny Kaomoji", "Cute rabbit text faces", m_kaomoji, K_LIB),
  "library-blushing-kaomoji": ("Blushing Kaomoji", "Shy, rosy-cheeked text faces", m_kaomoji, K_LIB),
  "library-dongers": ("Dongers", "Raise-your-dongers text faces", m_kaomoji, K_LIB),
  "library-angry-kaomoji": ("Angry Kaomoji", "Rage and table-flip text faces", m_kaomoji, K_LIB),
  "library-flower-kaomoji": ("Flower Kaomoji", "Flower-decorated text faces", m_kaomoji, K_LIB),
