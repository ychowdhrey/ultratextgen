...
PAGES = {
  ...
  "usecase-arena-of-valor-name-generator": ("Arena of Valor Name Generator", "Stylish AoV names, 12 char checker", m_gamepad, K_USE),
...
"it-da-stampare-lettere-da-colorare": ("Lettere da Colorare", "Alfabeto A-Z a contorno morbido, una lettera per foglio", m_grid, K_PRINT),
"nl-om-uit-te-printen-blokletters": ("Blokletters om uit te Printen", "Holle letters A-Z en 0-9 om uit te knippen", P(m_letter_stencil, letter="B"), K_PRINT),
"nl-om-uit-te-printen": ("Om uit te Printen", "Gratis letters om te printen, knippen en kleuren", m_grid, K_PRINT),
