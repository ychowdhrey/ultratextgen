...
/* ===================================================================== */
{
  ...
  faq: [
    { q: 'How do I make a blank name in a game?', a: 'Copy an invisible Unicode character, such as the Hangul Filler (U+3164), and paste it into the name field instead of a space. Which one a game accepts differs: players report Free Fire has rejected U+3164 since around patch OB43, so try another blank there. If a single one is rejected as already taken, paste it two or three times so the name is unique but still looks empty.' },
